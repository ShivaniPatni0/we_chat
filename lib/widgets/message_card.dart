...
class _MessageCardState extends State<MessageCard> {
  ...
  Widget build(BuildContext context) {
    bool itMe = APIs.user.uid == widget.message.fromId;
    return InkWell(
      onLongPress: () => _showBottomSheet(itMe),
      child: itMe ? _greenMessage() : _blueMessage(),
    );
  }

//sender and another user message
  Widget _blueMessage() {
